...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:cn="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:in="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:u="utils" version="2.0" exclude-result-prefixes="cac cbc u cn in xs">
	...
	<xsl:variable name="labels">
		<g id="attachments">
			...
			<f id="Download">
				<t id="en">Download</t>
				<t id="de">Herunterladen</t>
			</f>
			<f id="Embedded">
				<t id="en">Embedded</t>
				<t id="de">Eingebettet</t>
			</f>
		</g>
		<g id="delivery">
			<f id="Address">
			...
			<f id="DeliveryID">
				<t id="en">Location</t>
				<t id="de">Bezeichner</t>
			</f>
		</g>
		<g id="document">
			<f id="CreditNote">
				<t id="en">Credit Note</t>
				<t id="de">Gutschrift</t>
			</f>
			<f id="Invoice">
				<t id="en">Invoice</t>
				<t id="de">Rechnung</t>
		...
		<g id="line">
			...
			<f id="AllowanceIncluded">
				...
				<t id="de">Inklusive Zulage</t>
			</f>
			<f id="AllowanceTotalAmount">
				<t id="en">Allowance Total</t>
				<t id="de">Zulagen insgesamt</t>
			</f>
			<f id="Charge">
				<t id="en">Charge</t>
				<t id="de">berechnen</t>
		...
		<g id="metadata">
			...
			<f id="InvoiceDocumentReference">
				...
				<t id="de">Vorherige Rechnungsreferenz</t>
			</f>
			<f id="InvoicePeriod">
				<t id="en">Invoice Period</t>
				<t id="de">Rechnungsperiode</t>
		...
		<g id="party">
			...
			<f id="EndpointID">
				...
				<t id="de">Technische Adresse</t>
			</f>
			<f id="PartyIdentification">
				<t id="en">Party Identification</t>
				<t id="de">Parteiidentifikation</t>
			</f>
			<f id="PartyTaxScheme">
				<t id="en">Tax Identification</t>
				<t id="de">Steueridentifikation</t>
			</f>
			<f id="Supplier">
				<t id="en">Supplier</t>
				<t id="de">Lieferanten</t>
			</f>
		</g>
		<g id="payment">
			<f id="Payment">
		...
		<g id="total">
			...
			<f id="TaxExclusiveAmount">
				...
				<t id="de">Steuer exklusiv</t>
			</f>
			<f id="TaxInclusiveAmount">
				<t id="en">Tax Inclusive</t>
				<t id="de">Steuer inklusive</t>
			</f>
			<f id="Totals">
				<t id="en">Totals</t>
				<t id="de">Summen</t>
