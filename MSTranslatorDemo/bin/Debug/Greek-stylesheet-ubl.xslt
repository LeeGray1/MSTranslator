...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:cn="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:in="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:u="utils" version="2.0" exclude-result-prefixes="cac cbc u cn in xs">
	...
	<xsl:variable name="labels">
		<g id="attachments">
			...
			<f id="Download">
				<t id="en">Download</t>
				<t id="el">Κατεβάσετε</t>
			</f>
			<f id="Embedded">
				<t id="en">Embedded</t>
				<t id="el">Ενσωματωμένο</t>
			</f>
		</g>
		<g id="delivery">
			<f id="Address">
			...
			<f id="DeliveryDate">
				<t id="en">Date</t>
				<t id="el">Ημερομηνία</t>
			</f>
			<f id="DeliveryID">
				<t id="en">Location</t>
				<t id="el">Αναγνωριστικό</t>
			</f>
		</g>
		<g id="document">
			<f id="CreditNote">
				<t id="en">Credit Note</t>
				<t id="el">Πιστωτικό Σημείωμα</t>
			</f>
			<f id="Invoice">
				<t id="en">Invoice</t>
				<t id="el">Τιμολόγιο</t>
		...
		<g id="line">
			...
			<f id="AllowanceIncluded">
				...
				<t id="el">Περιλαμβάνεται επίδομα</t>
			</f>
			<f id="AllowanceTotalAmount">
				<t id="en">Allowance Total</t>
				<t id="el">Σύνολο δικαιωμάτων εκπομπής</t>
			</f>
			<f id="Charge">
				<t id="en">Charge</t>
				<t id="el">Χρέωση</t>
		...
		<g id="metadata">
			...
			<f id="InvoiceDocumentReference">
				...
				<t id="el">Προηγούμενη αναφορά τιμολογίου</t>
			</f>
			<f id="InvoicePeriod">
				<t id="en">Invoice Period</t>
				<t id="el">Περίοδος Τιμολογίου</t>
			...
			<f id="IssueDate">
				...
				<t id="el">Ημερομηνία έκδοσης</t>
			</f>
			<f id="Metadata">
				<t id="en">Metadata</t>
				<t id="el">Μεταδεδομένα</t>
			</f>
		...
		<g id="party">
			...
			<f id="EndpointID">
				...
				<t id="el">Τεχνική διεύθυνση</t>
			</f>
			<f id="PartyIdentification">
				<t id="en">Party Identification</t>
				<t id="el">Αναγνώριση κόμματος</t>
			</f>
			<f id="PartyTaxScheme">
				<t id="en">Tax Identification</t>
				<t id="el">Φορολογική Ταυτότητα</t>
			</f>
			<f id="Supplier">
				<t id="en">Supplier</t>
				<t id="el">Προμηθευτής</t>
			</f>
		</g>
		<g id="payment">
			<f id="Payment">
		...
		<g id="tax">
			...
			<f id="Tax">
				<t id="en">Tax</t>
				<t id="el">Φορολογική</t>
			</f>
			<f id="TaxableAmount">
				<t id="en">Taxable</t>
				<t id="el">Φορολογητέα</t>
			</f>
			<f id="TaxAmount">
				<t id="en">Tax</t>
				<t id="el">Φορολογική</t>
		...
		<g id="total">
			...
			<f id="PayableRoundingAmount">
				...
				<t id="el">Ποσό στρογγυλοποίησης</t>
			</f>
			<f id="PrepaidAmount">
				<t id="en">Prepaid</t>
				<t id="el">Προπληρωμένη</t>
			</f>
			<f id="TaxExclusiveAmount">
				<t id="en">Tax Exclusive</t>
				<t id="el">Αποκλειστικός Φόρος</t>
			</f>
			<f id="TaxInclusiveAmount">
				<t id="en">Tax Inclusive</t>
				<t id="el">Φόρος χωρίς αποκλεισμούς</t>
			</f>
			<f id="Totals">
				<t id="en">Totals</t>
				<t id="el">Σύνολα</t>
	...
	<xsl:param name="language" select="'el'"/>
