	...
	<xsl:variable name="labels">
		<g id="attachments">
			<f id="Attachments">
				...
				<t id="fr">Pièces jointes</t>
			</f>
			<f id="Download">
				<t id="en">Download</t>
				<t id="fr">Télécharger</t>
			</f>
			<f id="Embedded">
				<t id="en">Embedded</t>
				<t id="fr">Intégré</t>
		...
		<g id="delivery">
			...
			<f id="DeliveryID">
				<t id="en">Location</t>
				<t id="fr">Identificateur</t>
			</f>
		</g>
		<g id="document">
			<f id="CreditNote">
				<t id="en">Credit Note</t>
				<t id="fr">Note de crédit</t>
			</f>
			<f id="Invoice">
				<t id="en">Invoice</t>
				<t id="fr">Facture</t>
		...
		<g id="metadata">
			...
			<f id="InvoiceDocumentReference">
				...
				<t id="fr">Référence de facture précédente</t>
			</f>
			<f id="InvoicePeriod">
				<t id="en">Invoice Period</t>
				<t id="fr">Période de facturation</t>
			...
			<f id="IssueDate">
				...
				<t id="fr">Date d’émission</t>
			</f>
			<f id="Metadata">
				<t id="en">Metadata</t>
				<t id="fr">Métadonnées</t>
			</f>
		...
		<g id="party">
			...
			<f id="EndpointID">
				...
				<t id="fr">Adresse technique</t>
			</f>
			<f id="PartyIdentification">
				<t id="en">Party Identification</t>
				<t id="fr">Identification des parties</t>
			</f>
			<f id="PartyTaxScheme">
				<t id="en">Tax Identification</t>
				<t id="fr">Identification fiscale</t>
			</f>
			<f id="Supplier">
				<t id="en">Supplier</t>
				<t id="fr">Fournisseur</t>
			</f>
		</g>
		<g id="payment">
			<f id="Payment">
		...
		<g id="total">
			...
			<f id="TaxExclusiveAmount">
				...
				<t id="fr">Exclusivité fiscale</t>
			</f>
			<f id="TaxInclusiveAmount">
				<t id="en">Tax Inclusive</t>
				<t id="fr">Fiscalité inclusive</t>
			</f>
			<f id="Totals">
				<t id="en">Totals</t>
				<t id="fr">Totaux</t>
